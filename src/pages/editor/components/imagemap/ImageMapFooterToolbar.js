        ...
        <div className="rde-editor-footer-toolbar-interaction">
          <Button.Group>
            <CommonButton
              ...
              icon="mouse-pointer"
              tooltipTitle={formatMessage({id: 'editor.action.selection'})}
            />
            <CommonButton
              ...
              tooltipTitle={formatMessage({id: 'editor.action.grab'})}
              icon="hand-rock"
            />
          </Button.Group>
        </div>
        <div className="rde-editor-footer-toolbar-zoom">
          <Button.Group>
            <CommonButton
              ...
              icon="search-minus"
              tooltipTitle={formatMessage({id: 'editor.action.zoom-out'})}
            />
            <CommonButton
              onClick={() => {
                canvasRef.zoomHandlers.zoomOneToOne();
              }}
              tooltipTitle={formatMessage({id: 'editor.action.one-to-one'})}
            >
              {`${zoomValue}%`}
            </CommonButton>
            <CommonButton
              ...
              tooltipTitle={formatMessage({id: 'editor.action.fit'})}
              icon="expand"
            />
            <CommonButton
              style={{borderBottomRightRadius: '8px', borderTopRightRadius: '8px'}}
              ...
              icon="search-plus"
              tooltipTitle={formatMessage({id: 'editor.action.zoom-in'})}
            />
          </Button.Group>
        </div>
        <div className="rde-editor-footer-toolbar-preview">
          <Tooltip title={formatMessage({id: 'editor.action.preview'})}>
