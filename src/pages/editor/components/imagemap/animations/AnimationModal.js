  ...
  render() {
    ...
    return (
      <Modal
        ...
        visible={visible}
      >
        <Form.Item label={formatMessage({id: 'editor.common.title'})} required colon={false} hasFeedback help={validateTitle.help}
                   validateStatus={validateTitle.validateStatus}>
          <Input value={animation.title} onChange={(e) => {
            onChange(null, {animation: {title: e.target.value}}, {animation: {...animation, title: e.target.value}});
          }}/>
        </Form.Item>
