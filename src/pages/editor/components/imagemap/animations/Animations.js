    ...
    onValid: (value) => {
      if (!value || !value.length) {
        return {
          ...
          help: formatMessage({id: 'editor.validation.enter-property'}),
        };
      }
      ...
      return {
        validateStatus: 'error',
        help: formatMessage({id: 'editor.validation.already-property'}, {id: 'editor.common.title'}),
      };
    },
  }
        ...
        <Form>
          <FlexBox flexDirection="column">
            <FlexBox justifyContent="flex-end" style={{padding: 8}}>
              ...
              <AnimationModal ref={(c) => {
                this.modalRef = c;
              }} validateTitle={validateTitle} visible={visible} onOk={onOk} animation={animation} onCancel={onCancel}
                              onChange={onChange} onValid={onValid}/>
            </FlexBox>
