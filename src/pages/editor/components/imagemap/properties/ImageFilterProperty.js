  ...
  render(canvasRef, form, data) {
    ...
    return (
      <Row>
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.grayscale'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.invert'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.sepia'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.brownie'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.vintage'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.blackwhite'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.technicolor'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.polaroid'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.sharpen'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.emboss'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.gamma'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.color.red'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.color.green'})}>
              {
          ...
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.color.blue'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.brightness'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.contrast'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.saturation'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.hue'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.noise'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.pixelate'})}>
              {
        ...
        <Row>
          <Col md={24} lg={6}>
            <Form.Item label={formatMessage({id: 'editor.imagemap.filter.blur'})}>
              {
